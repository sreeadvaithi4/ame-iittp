...
const StudentCard = ({ student }: { student: StudentRep }) => (
  <div className="group bg-card border border-border rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-300 text-center flex flex-col items-center h-full">
    <div className="w-28 h-28 rounded-full bg-primary/10 flex items-center justify-center mb-5 border-4 border-primary/30 group-hover:border-primary group-hover:bg-primary/20 transition-all duration-300 overflow-hidden">
      {student.image ? (
      ...
      <section className="py-16 md:py-24 bg-secondary">
        <div className="container-section">
          ...
          <div className="flex justify-center gap-8 mb-8 max-w-3xl mx-auto">
            {row1.map((student) => (
              <div key={student.name} className="w-full max-w-[280px]">
