          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            ...
            animationDelay: `${index * 0.1}s`
                ...
                <div className="flex items-center justify-center gap-3">
                  <a href={faculty.linkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary/20 text-primary flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover:scale-110" title="LinkedIn">
